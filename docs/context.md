...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| Experience        | The browser lifecycle from capability check through loading, running, paused, context-lost, recovered, failed, and disposed states. | Calling only the page or renderer “the game.” |
